...
<html lang="en-US">
   ...
   <head>
      ...
      <title>Allegretto - Elérhetőségeink</title>
      ...
      <link rel='stylesheet' id='263-layout.css-css'  href='../wp-content/uploads/sites/4/zion-builder/cache/263-layout4dc3.css?ver=a38334b814ba87984878c840b07a2ca9' type='text/css' media='all' />
      ...
      <script type='text/javascript'>
         /* <![CDATA[ */
         var wpp_params = {"rest_api":"1","sampling_active":"0","sampling_rate":"100","ajax_url":"https:\/\/demos.hogash.com\/dannys\/wp-json\/wordpress-popular-posts\/v1\/popular-posts\/","action":"update_views_ajax","ID":"263","token":"bf51eb255e","debug":"1"};
         /* ]]> */
      </script>
      ...
      <link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embede96f.json?url=https%3A%2F%2Fdemos.hogash.com%2Fdannys%2Fcontact-us-with-google-map%2F" />
      <link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embede6b6?url=https%3A%2F%2Fdemos.hogash.com%2Fdannys%2Fcontact-us-with-google-map%2F&amp;format=xml" />
   ...
   <body class="page-template-default page page-id-263 woocommerce-no-js" itemscope="itemscope" itemtype="https://schema.org/WebPage" >
         ...
         <main id="content" class="dn-siteContent dn-isPage dn-isSingle dn-isPageBuilder">
            <div class="dn-siteContainer ">
               <div class="zn_pb_wrapper clearfix zn_sortable_content" data-droplevel="0">
                  <section class="eluidab75bc13  zn-section zn-section--height-custom zn-section--contentValign-middle" id="eluidab75bc13">
                     <div class="zn-bgSource "  >
                        <div class="zn-bgSource-image" style="background-image:url(../wp-content/uploads/sites/4/2017/05/img_18.jpg);background-repeat:no-repeat;background-position:center center;background-size:cover;background-attachment:scroll"></div>
                     ...
                     <div class="zn-sectionContainer zn-sectionContainer--default zn_dummy_value">
                        <div class="row zn-section-MainRow ">
                           <div class="eluid11c0b525  znColumnElement col-md-12 zn_edit_mode" id="eluid11c0b525" >
                              <div class="znColumnElement-innerWrapper znColumnElement-iW-eluid11c0b525 znColumnElement-innerWrapper--valign-top znColumnElement-innerWrapper--halign-left " >
                                 <div class="znColumnElement-innerContent">
                                    <h3 class="eluid522f5b2a  dn-heading" id="eluid522f5b2a" itemprop="headline" >Allegretto</h3>
                                    <h1 class="eluiddc8e34f4  dn-heading" id="eluiddc8e34f4" itemprop="headline" >Elérhetőségeink</h1>
                  ...
                  <section class="eluid6c5c4889  zn-section zn-section--height-auto zn-section--contentValign-top" id="eluid6c5c4889">
                     <div class="zn-sectionContainer zn-sectionContainer--default zn_dummy_value">
                        <div class="row zn-section-MainRow ">
                                    ...
                                    <div id="eluid48bbc175" class="eluid48bbc175  zn-contactFormElement">
                                       <form action="#" id="form_eluid48bbc175" method="post" class="zn-contactForm" data-redirect="">
                                          <div class="row zn-contactForm-row gutter-md">
                                             <div class="col-sm-4">
                                                <div class="zn-formItem-wrapper zn-formItem--text "><label for="zn_form_field_name1_0" class="zn-formItem-label">Név</label><input type="text" name="zn_form_field_name1_0" id="zn_form_field_name1_0" placeholder="" value="" class="zn-formItem-field zn-formItem-field--text form-control zn_validate_not_empty"/></div>
                                             </div>
                                             <div class="col-sm-4">
                                                <div class="zn-formItem-wrapper zn-formItem--text "><label for="zn_form_field_email1_1" class="zn-formItem-label">Email</label><input type="text" name="zn_form_field_email1_1" id="zn_form_field_email1_1" placeholder="" value="" class="zn-formItem-field zn-formItem-field--text form-control zn_validate_is_email"/></div>
                                             </div>
                                             <div class="col-sm-4">
                                                <div class="zn-formItem-wrapper zn-formItem--text "><label for="zn_form_field_phone1_2" class="zn-formItem-label">Telefon</label><input type="text" name="zn_form_field_phone1_2" id="zn_form_field_phone1_2" placeholder="" value="" class="zn-formItem-field zn-formItem-field--text form-control zn_validate_is_numeric"/></div>
                                             </div>
                                             <div class="col-sm-12">
                                                <div class="zn-formItem-wrapper zn-formItem--textarea "><label for="zn_form_field_message1_3" class="zn-formItem-label">Üzenet</label><textarea name="zn_form_field_message1_3" id="zn_form_field_message1_3" placeholder="" class="zn-formItem-field zn-formItem-field--textarea form-control zn_validate_not_empty" cols="40" rows="6"></textarea></div>
                                             </div>
                                             <div class="col-sm-12">
                                                <div class="zn-formItem-wrapper zn-formItem--hidden "><input type="hidden" name="zn_pb_form_submit_1" id="zn_pb_form_submit_1" value="1" class="zn-formItem-field zn-formItem-field--hidden zn_validate_none"/></div>
                                             </div>
                                             <div class="col-sm-12">
                                                <div class="zn-formItem-wrapper zn-formItem--response">
                                                   <div class="zn_contact_ajax_response" id="zn_form_id1" ></div>
                                                </div>
                                                <div class="zn-formItem-wrapper zn-formItem--submit text-center"><button class="zn-formSubmit btn btn-primary  btn--square" type="submit">ÜZENET KÜLDÉSE</button></div>
                                             </div>
                                          </div>
                                       </form>
                                    </div>
                  ...
                  <section class="eluid59af8542  zn-section zn-section--height-auto zn-section--contentValign-top" id="eluid59af8542">
                     <div class="zn-sectionContainer zn-sectionContainer--full zn-sectionContainer--sidePad">
                        <div class="row zn-section-MainRow ">
                           <div class="eluidc60d243a  znColumnElement col-md-12 zn_edit_mode" id="eluidc60d243a" >
                              <div class="znColumnElement-innerWrapper znColumnElement-iW-eluidc60d243a znColumnElement-innerWrapper--valign-top znColumnElement-innerWrapper--halign-left " >
                                 <div class="znColumnElement-innerContent">
                                    <div id="eluide7b69a18" class="eluide7b69a18  zn-googleMap">
                                       <div id="zn_google_map_eluide7b69a18" class="zn-mapCanvas"></div>
      ...
      <script type="text/javascript">jQuery(document).ready(function($) {
         var zn_google_map_eluide7b69a18 = new Zn_google_map('zn_google_map_eluide7b69a18', [47.4938868,19.060], '', [[47.4938868,19.060, '<p>Múzem krt. 1.<br />BUDAPEST<br />1053<br />MAGYARORSZÁG</p>' ,'../wp-content/uploads/sites/4/2017/05/map_marker.png',50,'DROP',],], 'ROADMAP', 15, false, [
         {
            "featureType": "all",
