...
<html lang="en-US">
   ...
   <head>
      ...
      <title>Allegretto - Galéria</title>
   ...
   <body class="page-template-default page page-id-263 woocommerce-no-js" itemscope="itemscope" itemtype="https://schema.org/WebPage" >
               ...
               <div class="zn_pb_wrapper clearfix zn_sortable_content" data-droplevel="0">
                  <section class="eluidab75bc13  zn-section zn-section--height-custom zn-section--contentValign-middle" id="eluidab75bc13">
                     <div class="zn-bgSource "  >
                        <div class="zn-bgSource-image" style="background-image:url(../wp-content/uploads/sites/4/2017/05/img_08.jpg);background-repeat:no-repeat;background-position:center center;background-size:cover;background-attachment:scroll"></div>
                           ...
                           <div class="eluid11c0b525  znColumnElement col-md-12 zn_edit_mode" id="eluid11c0b525" >
                              <div class="znColumnElement-innerWrapper znColumnElement-iW-eluid11c0b525 znColumnElement-innerWrapper--valign-top znColumnElement-innerWrapper--halign-left " >
                                 <div class="znColumnElement-innerContent">
                                    ...
                                    <h1 class="eluiddc8e34f4  dn-heading" id="eluiddc8e34f4" itemprop="headline" >Galéria</h1> 
                                    <p class="eluid5358cdb0  dn-heading" id="eluid5358cdb0" itemprop="headline" >Fascinating view</p> 
                                    <div class="eluid21dece02  dn-heading" id="eluid21dece02" itemprop="headline" ></div> 
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <section class="eluid6c5c4889  zn-section zn-section--height-auto zn-section--contentValign-top" id="eluid6c5c4889">
                                 ...
                                 <div class="znColumnElement-innerContent" style="width: 100%">
      ...
      <script type="text/javascript">jQuery(document).ready(function($) {
         var zn_google_map_eluide7b69a18 = new Zn_google_map('zn_google_map_eluide7b69a18', [51.502055, -0.141115], '', [[51.502055,-0.141115,'<p>Your Location</p>','../wp-content/uploads/sites/4/2017/05/map_marker.png',50,'DROP',],], 'ROADMAP', 15, false, [
         {
            "featureType": "all",
